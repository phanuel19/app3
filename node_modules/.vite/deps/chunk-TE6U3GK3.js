import {
  useTheme,
  useThemeProps
} from "./chunk-BPCQDPWT.js";
import {
  useDefaultProps
} from "./chunk-DWVX343B.js";
import {
...
function stack_default() {
  var keys = constant_default([]), order2 = none_default2, offset2 = none_default, value = stackValue;
  function stack(data) {
...
function useDrawingArea() {
  ...
  return React3.useMemo(() => ({
    ...
    right: right2,
    isPointInside
  }), [height, left2, top2, width, bottom2, right2, isPointInside]);
}
...
function tickSpec(start3, stop2, count2) {
  ...
  if (i2 < i1 && 0.5 <= count2 && count2 < 2) return tickSpec(start3, stop2, count2 * 2);
  return [i1, i2, inc];
}
...
var Portal = React49.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React49.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React49.isValidElement(children)) {
      ...
      return React49.cloneElement(children, newProps);
    }
    return children;
  }
...
function GlobalStyles(props) {
  return (0, import_jsx_runtime20.jsx)(GlobalStyles_default, {
    ...props,
...
var Popper3 = React53.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime23.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime23.jsx)(ChartsTooltipTable, {
      ...
      children: (0, import_jsx_runtime23.jsx)("tbody", {
        children: (0, import_jsx_runtime23.jsxs)(ChartsTooltipRow, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types15.default.func.isRequired,
  /**
...
var Typography = React58.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color2,
    ...themeProps
  } = useDefaultProps({
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types17.default.object.isRequired,
  /**
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React60.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React60.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React60.useMemo(() => {
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime28.jsx)(NoSsr_default, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime29.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime29.jsx)("rect", {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React65.useMemo(
  ...
  const padding = React65.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React65.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React65.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React65.useMemo(() => {
  ...
  return (0, import_jsx_runtime30.jsx)(NoSsr_default, {
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types19.default.arrayOf(import_prop_types19.default.shape({
    ...
    itemId: import_prop_types19.default.oneOfType([import_prop_types19.default.number, import_prop_types19.default.string]),
    label: import_prop_types19.default.string.isRequired,
    maxValue: import_prop_types19.default.oneOfType([import_prop_types19.default.instanceOf(Date), import_prop_types19.default.number]),
    minValue: import_prop_types19.default.oneOfType([import_prop_types19.default.instanceOf(Date), import_prop_types19.default.number]),
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime32.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React68.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  const refLength = direction === "column" ? height + top2 + bottom2 : width + left2 + right2;
  ...
  return (0, import_jsx_runtime33.jsxs)(React69.Fragment, {
    ...
    }), (0, import_jsx_runtime33.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime33.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types21.default.oneOf(["end", "middle", "start"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types21.default.oneOfType([import_prop_types21.default.number, import_prop_types21.default.string]),
  /**
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types21.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types21.default.number,
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default false
   */
  hideFirst: import_prop_types22.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types22.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React71.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime35.jsxs)(React71.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime35.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime35.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime35.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime35.jsx)(ChartsAxisHighlightPath, {
...
//# sourceMappingURL=chunk-TE6U3GK3.js.map
